        ...
        <div className="footerCmp">
            <footer>
                ...
                <div className="footerGetInTouch">
                    <h1>Get in touch</h1>
                    <ul>
                        <p>Any questions? Let us know or call us on +91 6782XXXXXX</p>
                ...
                <div className="paragraphFooter"><p>Copyright ©2024 All rights reserved | This template is made with ♡ by Developer.</p>
                <Link to = '' >Divyanshi Bhatia</Link>
                </div>
